...
use skia_winit_renderer::{generic::WindowManager, softbuffer::SoftBufferBackend};
use winit::{
...
fn main() {
    ...
    let mut window_manager = WindowManager::<SoftBufferBackend>::new(&event_loop).unwrap();
